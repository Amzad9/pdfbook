      ...
      <BrowserRouter>
        ...
        <Route path='/' element={<Home />}>
         ...
         <Route 
          ...
          />
          <Route 
            path='drainage-effluent-crops' 
            element={<Suspense fallback={<Loader />}><Drainage /></Suspense>} 
          />
           <Route 
            path='laser-land-levelling' 
            element={<Suspense fallback={<Loader />}><LaserLand /></Suspense>} 
          />
          <Route 
            path='zero-tillage-practices' 
            element={<Suspense fallback={<Loader />}><ZeroTillage /></Suspense>} 
          />
          <Route 
            path='hill-torrents-beneficial' 
            element={<Suspense fallback={<Loader />}><Beneficial /></Suspense>} 
          />
          <Route 
            path='intercropping' 
            element={<Suspense fallback={<Loader />}><Intercropping /></Suspense>} 
          />
          <Route 
            path='tunnel-farming' 
            element={<Suspense fallback={<Loader />}><Tunnel /></Suspense>} 
          />
          <Route 
            path='vegetables-raised-beds' 
            element={<Suspense fallback={<Loader />}><Vegetables /></Suspense>} 
          />
          <Route 
            path='orchard-ring-basins' 
            element={<Suspense fallback={<Loader />}><Orchard /></Suspense>} 
          />
          <Route 
            path='rainfed-agriculture' 
            element={<Suspense fallback={<Loader />}><Rainfed /></Suspense>} 
          />
          <Route 
            path='saline-aquaculture' 
            element={<Suspense fallback={<Loader />}><Saline /></Suspense>} 
          />
          <Route 
            path='tankaa' 
            element={<Suspense fallback={<Loader />}><Tankaa /></Suspense>} 
          />
          <Route 
            path='mobile-water-tank-monitoring' 
            element={<Suspense fallback={<Loader />}><MobileApplication /></Suspense>} 
          />
          <Route 
            path='bed-furrow-irrigation-bananas' 
            element={<Suspense fallback={<Loader />}><BedandFurrow /></Suspense>} 
          />
          <Route 
            path='kund' 
            element={<Suspense fallback={<Loader />}><Kund /></Suspense>} 
          />
          <Route 
            path='great-wall-surajpura' 
            element={<Suspense fallback={<Loader />}><TheGreatWall /></Suspense>} 
          />
        </Route>
      </Routes> 
      </BrowserRouter>
