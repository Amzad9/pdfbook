...
function BananaResidue() {
  return (
    <div className="bg-white p-4">
           <img src={Page20} alt="Evaluation" />
           <img src={Page21} alt="Evaluation" className="mt-5" />
           <img src={Page22} alt="Evaluation" className="mt-5" />
           <img src={Page23} alt="Evaluation" className="mt-5" />
       </div>
  )
}
